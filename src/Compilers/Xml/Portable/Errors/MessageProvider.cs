...
namespace Microsoft.CodeAnalysis.Xml
{
    internal sealed class MessageProvider : CommonMessageProvider, IObjectWritable
    {
        ...
        // Given a message identifier (e.g., XML0219), severity, warning as error and a culture, 
        // get the entire prefix (e.g., "error XML0219:" for XML) used on error messages.
        ...
        {
            var info = new DiagnosticInfo(Xml.MessageProvider.Instance, code, args);
            return new XmlDiagnostic(info, location);
        }

        public override Diagnostic CreateDiagnostic(DiagnosticInfo info)
        {
            return new XmlDiagnostic(info, Location.None);
        }
        ...
        public override ReportDiagnostic GetDiagnosticReport(DiagnosticInfo diagnosticInfo, CompilationOptions options)
        {
            ...
            // TODO: MGoertz
            //return XmlDiagnosticFilter.GetDiagnosticReport(diagnosticInfo.Severity,
            //                                                  true,
