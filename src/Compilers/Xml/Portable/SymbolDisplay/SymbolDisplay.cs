    ...
    public static class SymbolDisplay
    {
            ...
            bool minimal)
        {
            ...
            if (minimal)
            {
                ...
                {
                    throw new ArgumentException(XmlResources.SyntaxTreeSemanticModelMust);
                }
                else if (positionOpt < 0 || positionOpt > semanticModelOpt.SyntaxTree.Length) // Note: not >= since EOF is allowed.
                {
                    throw new ArgumentOutOfRangeException(XmlResources.PositionNotWithinTree);
                }
            }
            else
            {
        ...
        /// <summary>
        /// Returns a XML string literal with the given value.
        /// </summary>
        ...
        /// <summary>
        /// Returns a XML character literal with the given value.
        /// </summary>
