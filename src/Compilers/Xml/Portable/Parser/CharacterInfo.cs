...
{
    /// <summary>
    /// Defines a set of methods to determine how Unicode characters are treated by the XML parser.
    /// </summary>
    public static partial class SyntaxFacts
    {
        ...
        /// <summary>
        /// Returns true if the Unicode character can be the starting character of a XML identifier.
        /// </summary>
        /// <param name="ch">The Unicode character.</param>
        ...
        /// <summary>
        /// Returns true if the Unicode character can be a part of a XML identifier.
        /// </summary>
        /// <param name="ch">The Unicode character.</param>
