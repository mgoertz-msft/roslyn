        ...
        private struct Reader
        {
                ...
                out BlendedNode blendedNode)
            {
                ...
                blendedNode = CreateBlendedNode(
                    node: (Xml.XmlSyntaxNode)currentNodeOrToken.AsNode(),
            ...
            private bool CanReuse(SyntaxNodeOrToken nodeOrToken)
            {
                ...
                if (nodeOrToken.ContainsDiagnostics ||
                    (nodeOrToken.IsToken && ((XmlSyntaxNode)nodeOrToken.AsToken().Node).ContainsSkippedText && nodeOrToken.Parent.ContainsDiagnostics))
                {
                    return false;
                }
                ...
                if ((nodeOrToken.IsToken && nodeOrToken.AsToken().IsMissing) ||
                    (nodeOrToken.IsNode && IsIncomplete((Xml.XmlSyntaxNode)nodeOrToken.AsNode())))
                {
                    return false;
                }
            ...
            private static bool IsIncomplete(Xml.XmlSyntaxNode node)
            {
            ...
            private BlendedNode CreateBlendedNode(Xml.XmlSyntaxNode node, SyntaxToken token)
            {
