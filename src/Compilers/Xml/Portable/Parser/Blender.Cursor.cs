...
namespace Microsoft.CodeAnalysis.Xml.Syntax.InternalSyntax
{
    internal partial struct Blender
    {
        ...
        private struct Cursor
        {
            ...
            public static Cursor FromRoot(Xml.XmlSyntaxNode node)
            {
            ...
            private static int IndexOfNodeInParent(SyntaxNode node)
            {
                ...
                var index = SyntaxNodeOrToken.GetFirstChildIndexSpanningPosition(children, ((Xml.XmlSyntaxNode)node).Position);
