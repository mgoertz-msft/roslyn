...
namespace Microsoft.CodeAnalysis.Xml.Syntax.InternalSyntax
{
    ...
    internal partial class SyntaxToken : XmlSyntaxNode
    {
        //====================
        ...
        internal static SyntaxToken StringLiteral(XmlSyntaxNode leading, string text, XmlSyntaxNode trailing)
        {
        ...
        internal SyntaxList<XmlSyntaxNode> LeadingTrivia
        {
            get { return new SyntaxList<XmlSyntaxNode>(this.GetLeadingTrivia()); }
        }

        internal SyntaxList<XmlSyntaxNode> TrailingTrivia
        {
            get { return new SyntaxList<XmlSyntaxNode>(this.GetTrailingTrivia()); }
        }
