...
namespace Microsoft.CodeAnalysis.Xml.Syntax.InternalSyntax
{
    ...
    internal static partial class SyntaxFactory
    {
        ...
        public static SyntaxList<TNode> List<TNode>() where TNode : XmlSyntaxNode
        {
            return default(SyntaxList<TNode>);
        }

        public static SyntaxList<TNode> List<TNode>(TNode node) where TNode : XmlSyntaxNode
        {
            return new SyntaxList<TNode>(SyntaxList.List(node));
        }

        public static SyntaxList<TNode> List<TNode>(TNode node0, TNode node1) where TNode : XmlSyntaxNode
        {
            return new SyntaxList<TNode>(SyntaxList.List(node0, node1));
        }

        internal static GreenNode ListNode(XmlSyntaxNode node0, XmlSyntaxNode node1)
        {
            return SyntaxList.List(node0, node1);
        }

        public static SyntaxList<TNode> List<TNode>(TNode node0, TNode node1, TNode node2) where TNode : XmlSyntaxNode
        {
            return new SyntaxList<TNode>(SyntaxList.List(node0, node1, node2));
        }

        internal static GreenNode ListNode(XmlSyntaxNode node0, XmlSyntaxNode node1, XmlSyntaxNode node2)
        {
            return SyntaxList.List(node0, node1, node2);
        }

        public static SyntaxList<TNode> List<TNode>(params TNode[] nodes) where TNode : XmlSyntaxNode
        {
            if (nodes != null)
            {
        ...
        public static SeparatedSyntaxList<TNode> SeparatedList<TNode>(TNode node) where TNode : XmlSyntaxNode
        {
            return new SeparatedSyntaxList<TNode>(new SyntaxList<XmlSyntaxNode>(node));
        }

        public static SeparatedSyntaxList<TNode> SeparatedList<TNode>(SyntaxToken token) where TNode : XmlSyntaxNode
        {
            return new SeparatedSyntaxList<TNode>(new SyntaxList<XmlSyntaxNode>(token));
        }

        public static SeparatedSyntaxList<TNode> SeparatedList<TNode>(TNode node1, SyntaxToken token, TNode node2) where TNode : XmlSyntaxNode
        {
            return new SeparatedSyntaxList<TNode>(new SyntaxList<XmlSyntaxNode>(SyntaxList.List(node1, token, node2)));
        }

        public static SeparatedSyntaxList<TNode> SeparatedList<TNode>(params XmlSyntaxNode[] nodes) where TNode : XmlSyntaxNode
        {
            if (nodes != null)
            {
