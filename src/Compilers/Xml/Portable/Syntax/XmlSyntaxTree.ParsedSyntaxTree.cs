...
namespace Microsoft.CodeAnalysis.Xml
{
    ...
    {
        private class ParsedSyntaxTree : XmlSyntaxTree
        {
            private readonly XmlParseOptions _options;
            private readonly string _path;
            private readonly XmlSyntaxNode _root;
            private readonly Encoding _encodingOpt;
            private readonly SourceHashAlgorithm _checksumAlgorithm;
            private SourceText _lazyText;

            internal ParsedSyntaxTree(SourceText textOpt, Encoding encodingOpt, SourceHashAlgorithm checksumAlgorithm, string path, XmlParseOptions options, XmlSyntaxNode root, bool cloneRoot = true)
            {
