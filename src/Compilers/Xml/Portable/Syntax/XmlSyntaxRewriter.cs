...
{
    /// <summary>
    /// Represents a <see cref="XmlSyntaxVisitor{TResult}"/> which descends an entire <see cref="XmlSyntaxNode"/> graph and
    /// may replace or remove visited SyntaxNodes in depth-first order.
    /// </summary>
    public abstract partial class XmlSyntaxRewriter : XmlSyntaxVisitor<SyntaxNode>
    {
        ...
        public override SyntaxNode Visit(SyntaxNode node)
        {
            if (node != null)
            {
                ...
                var result = ((XmlSyntaxNode)node).Accept(this);
        ...
        public virtual SyntaxTrivia VisitTrivia(SyntaxTrivia trivia)
        {
            ...
            {
                var structure = (XmlSyntaxNode)trivia.GetStructure();
