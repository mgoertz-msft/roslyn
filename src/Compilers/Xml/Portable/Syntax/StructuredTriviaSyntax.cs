...
{
    /// <summary>
    /// It's a non terminal Trivia XmlSyntaxNode that has a tree underneath it.
    /// </summary>
    public abstract partial class StructuredTriviaSyntax : XmlSyntaxNode, IStructuredTriviaSyntax
    {
        private SyntaxTrivia _parent;

        internal StructuredTriviaSyntax(InternalSyntax.XmlSyntaxNode green, SyntaxNode parent, int position)
