...
namespace Microsoft.CodeAnalysis
{
    public static class XmlExtensions
    {
        ...
        {
            return (object)token.Language == (object)LanguageNames.Xml ? (SyntaxKind)token.RawContextualKind : SyntaxKind.None;
        }
...
namespace Microsoft.CodeAnalysis.Xml
{
    public static class XmlExtensions
    {
        internal static bool IsXmlKind(int rawKind)
        {
            return rawKind > (int)SyntaxKind.XmlFirst && rawKind < (int)SyntaxKind.XmlLast;
        }

        public static SyntaxKind Kind(this SyntaxToken token)
        {
            var rawKind = token.RawKind;
            return IsXmlKind(rawKind) ? (SyntaxKind)rawKind : SyntaxKind.None;
        }
