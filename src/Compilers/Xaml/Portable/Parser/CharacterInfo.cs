...
{
    /// <summary>
    /// Defines a set of methods to determine how Unicode characters are treated by the XAML compiler.
    /// </summary>
    public static partial class SyntaxFacts
    {
        ...
        /// <summary>
        /// Returns true if the Unicode character can be the starting character of a XAML identifier.
        /// </summary>
        /// <param name="ch">The Unicode character.</param>
        ...
        /// <summary>
        /// Returns true if the Unicode character can be a part of a XAML identifier.
        /// </summary>
        /// <param name="ch">The Unicode character.</param>
