...
namespace Microsoft.CodeAnalysis.Xaml.Syntax.InternalSyntax
{
    internal partial struct Blender
    {
        ...
        private struct Cursor
        {
            ...
            public static Cursor FromRoot(Xaml.XamlSyntaxNode node)
            {
            ...
            private static int IndexOfNodeInParent(SyntaxNode node)
            {
                ...
                var index = SyntaxNodeOrToken.GetFirstChildIndexSpanningPosition(children, ((Xaml.XamlSyntaxNode)node).Position);
