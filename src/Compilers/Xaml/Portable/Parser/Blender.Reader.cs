        ...
        private struct Reader
        {
                ...
                out BlendedNode blendedNode)
            {
                ...
                blendedNode = CreateBlendedNode(
                    node: (Xaml.XamlSyntaxNode)currentNodeOrToken.AsNode(),
            ...
            private bool CanReuse(SyntaxNodeOrToken nodeOrToken)
            {
                ...
                if (nodeOrToken.ContainsDiagnostics ||
                    (nodeOrToken.IsToken && ((XamlSyntaxNode)nodeOrToken.AsToken().Node).ContainsSkippedText && nodeOrToken.Parent.ContainsDiagnostics))
                {
                    return false;
                }
                ...
                if ((nodeOrToken.IsToken && nodeOrToken.AsToken().IsMissing) ||
                    (nodeOrToken.IsNode && IsIncomplete((Xaml.XamlSyntaxNode)nodeOrToken.AsNode())))
                {
                    return false;
                }
            ...
            private static bool IsIncomplete(Xaml.XamlSyntaxNode node)
            {
            ...
            private BlendedNode CreateBlendedNode(Xaml.XamlSyntaxNode node, SyntaxToken token)
            {
