...
namespace Microsoft.CodeAnalysis.Xaml.Syntax.InternalSyntax
{
    ...
    internal abstract partial class SyntaxParser : IDisposable
    {
        ...
        protected Xaml.XamlSyntaxNode CurrentNode
        {
            get
            {
        ...
        protected void GetDiagnosticSpanForMissingToken(out int offset, out int width)
        {
            ...
            if (trivia != null)
            {
                SyntaxList<XamlSyntaxNode> triviaList = new SyntaxList<XamlSyntaxNode>(trivia);
        ...
        protected TNode AddError<TNode>(TNode node, int offset, int length, ErrorCode code, params object[] args) where TNode : XamlSyntaxNode
        {
            return WithAdditionalDiagnostics(node, MakeError(offset, length, code, args));
        }

        protected TNode AddError<TNode>(TNode node, XamlSyntaxNode location, ErrorCode code, params object[] args) where TNode : XamlSyntaxNode
        {
        ...
        protected TNode AddErrorToFirstToken<TNode>(TNode node, ErrorCode code) where TNode : XamlSyntaxNode
        {
            var firstToken = node.GetFirstToken();
            return WithAdditionalDiagnostics(node, MakeError(firstToken.GetLeadingTriviaWidth(), firstToken.Width, code));
        }

        protected TNode AddErrorToFirstToken<TNode>(TNode node, ErrorCode code, params object[] args) where TNode : XamlSyntaxNode
        {
            var firstToken = node.GetFirstToken();
            return WithAdditionalDiagnostics(node, MakeError(firstToken.GetLeadingTriviaWidth(), firstToken.Width, code, args));
        }

        protected TNode AddErrorToLastToken<TNode>(TNode node, ErrorCode code) where TNode : XamlSyntaxNode
        {
            int offset;
            int width;
        ...
        protected TNode AddErrorToLastToken<TNode>(TNode node, ErrorCode code, params object[] args) where TNode : XamlSyntaxNode
        {
            int offset;
            int width;
            GetOffsetAndWidthForLastToken(node, out offset, out width);
        ...
        private static void GetOffsetAndWidthForLastToken<TNode>(TNode node, out int offset, out int width) where TNode : XamlSyntaxNode
        {
        ...
        protected TNode AddLeadingSkippedSyntax<TNode>(TNode node, GreenNode skippedSyntax) where TNode : XamlSyntaxNode
        {
        ...
        protected TNode AddTrailingSkippedSyntax<TNode>(TNode node, GreenNode skippedSyntax) where TNode : XamlSyntaxNode
        {
        ...
        /// <returns></returns>
        private bool FindOffset(GreenNode root, XamlSyntaxNode location, out int offset)
        {
            int currentOffset = 0;
            offset = 0;
            if (root != null)
