...
#pragma warning disable RS0010
    /// <summary>
    /// Displays a symbol in the XAML style.
    /// </summary>
...
#pragma warning restore RS0010
    ...
    {
        /// <summary>
        /// Displays a symbol in the XAML style, based on a <see cref="SymbolDisplayFormat"/>.
        /// </summary>
        /// <param name="symbol">The symbol to be displayed.</param>
        /// <param name="format">The formatting options to apply.  If null is passed, <see cref="SymbolDisplayFormat.XamlErrorMessageFormat"/> will be used.</param>
        /// <returns>A formatted string that can be displayed to the user.</returns>
        /// <remarks>
        /// The return value is not expected to be syntactically valid XAML.
        /// </remarks>
            ...
            bool minimal)
        {
            ...
            if (minimal)
            {
                ...
                {
                    throw new ArgumentException(XamlResources.SyntaxTreeSemanticModelMust);
                }
                else if (positionOpt < 0 || positionOpt > semanticModelOpt.SyntaxTree.Length) // Note: not >= since EOF is allowed.
                {
                    throw new ArgumentOutOfRangeException(XamlResources.PositionNotWithinTree);
                }
            }
            else
            {
        ...
        /// <summary>
        /// Returns a XAML string literal with the given value.
        /// </summary>
        ...
        /// <summary>
        /// Returns a XAML character literal with the given value.
        /// </summary>
