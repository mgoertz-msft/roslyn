...
namespace Microsoft.CodeAnalysis.Xaml.Syntax.InternalSyntax
{
    ...
    internal partial class XamlSyntaxRewriter : XamlSyntaxVisitor<XamlSyntaxNode>
    {
        protected readonly bool VisitIntoStructuredTrivia;

        public XamlSyntaxRewriter(bool visitIntoStructuredTrivia = false)
        {
            this.VisitIntoStructuredTrivia = visitIntoStructuredTrivia;
        }

        public override XamlSyntaxNode VisitToken(SyntaxToken token)
        {
        ...
        public SyntaxList<TNode> VisitList<TNode>(SyntaxList<TNode> list) where TNode : XamlSyntaxNode
        {
        ...
        public SeparatedSyntaxList<TNode> VisitList<TNode>(SeparatedSyntaxList<TNode> list) where TNode : XamlSyntaxNode
        {
            // A separated list is filled with XAML nodes and XAML tokens.  Both of which
            // derive from InternalSyntax.XamlSyntaxNode.  So this cast is appropriately
            // typesafe.
            var withSeps = (SyntaxList<XamlSyntaxNode>)list.GetWithSeparators();
