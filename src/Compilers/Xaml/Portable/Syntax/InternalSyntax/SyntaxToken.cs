...
namespace Microsoft.CodeAnalysis.Xaml.Syntax.InternalSyntax
{
    ...
    internal partial class SyntaxToken : XamlSyntaxNode
    {
        //====================
        ...
        internal static readonly SyntaxKind FirstTokenWithWellKnownText = SyntaxKind.XamlFirst;
        ...
        internal static SyntaxToken StringLiteral(XamlSyntaxNode leading, string text, XamlSyntaxNode trailing)
        {
        ...
        internal SyntaxList<XamlSyntaxNode> LeadingTrivia
        {
            get { return new SyntaxList<XamlSyntaxNode>(this.GetLeadingTrivia()); }
        }

        internal SyntaxList<XamlSyntaxNode> TrailingTrivia
        {
            get { return new SyntaxList<XamlSyntaxNode>(this.GetTrailingTrivia()); }
        }
        ...
        public override TResult Accept<TResult>(XamlSyntaxVisitor<TResult> visitor)
        {
            return visitor.VisitToken(this);
        }

        public override void Accept(XamlSyntaxVisitor visitor)
        {
        ...
        {
            //throw ExceptionUtilities.Unreachable;
            Debug.Fail(ExceptionUtilities.Unreachable.Message);
            return null;
        }
    }
}
