...
namespace Microsoft.CodeAnalysis.Xaml.Syntax.InternalSyntax
{
    ...
    internal static partial class SyntaxFactory
    {
        ...
        internal static SyntaxToken XamlTextLiteral(GreenNode leading, string text, string value, GreenNode trailing)
        {
            return SyntaxToken.WithValue(SyntaxKind.XamlTextLiteralToken, leading, text, value, trailing);
        }

        internal static SyntaxToken XamlTextNewLine(GreenNode leading, string text, string value, GreenNode trailing)
        {
            ...
            return SyntaxToken.WithValue(SyntaxKind.XamlTextLiteralNewLineToken, leading, text, value, trailing);
        }

        internal static SyntaxToken XmlTextNewLine(string text)
        {
            return SyntaxToken.WithValue(SyntaxKind.XamlTextLiteralNewLineToken, null, text, text, null);
        }

        internal static SyntaxToken XmlEntity(GreenNode leading, string text, string value, GreenNode trailing)
        {
            return SyntaxToken.WithValue(SyntaxKind.XamlEntityLiteralToken, leading, text, value, trailing);
        }
        ...
        public static SyntaxList<TNode> List<TNode>() where TNode : XamlSyntaxNode
        {
            return default(SyntaxList<TNode>);
        }

        public static SyntaxList<TNode> List<TNode>(TNode node) where TNode : XamlSyntaxNode
        {
            return new SyntaxList<TNode>(SyntaxList.List(node));
        }

        public static SyntaxList<TNode> List<TNode>(TNode node0, TNode node1) where TNode : XamlSyntaxNode
        {
            return new SyntaxList<TNode>(SyntaxList.List(node0, node1));
        }

        internal static GreenNode ListNode(XamlSyntaxNode node0, XamlSyntaxNode node1)
        {
            return SyntaxList.List(node0, node1);
        }

        public static SyntaxList<TNode> List<TNode>(TNode node0, TNode node1, TNode node2) where TNode : XamlSyntaxNode
        {
            return new SyntaxList<TNode>(SyntaxList.List(node0, node1, node2));
        }

        internal static GreenNode ListNode(XamlSyntaxNode node0, XamlSyntaxNode node1, XamlSyntaxNode node2)
        {
            return SyntaxList.List(node0, node1, node2);
        }

        public static SyntaxList<TNode> List<TNode>(params TNode[] nodes) where TNode : XamlSyntaxNode
        {
            if (nodes != null)
            {
        ...
        public static SeparatedSyntaxList<TNode> SeparatedList<TNode>(TNode node) where TNode : XamlSyntaxNode
        {
            return new SeparatedSyntaxList<TNode>(new SyntaxList<XamlSyntaxNode>(node));
        }

        public static SeparatedSyntaxList<TNode> SeparatedList<TNode>(SyntaxToken token) where TNode : XamlSyntaxNode
        {
            return new SeparatedSyntaxList<TNode>(new SyntaxList<XamlSyntaxNode>(token));
        }

        public static SeparatedSyntaxList<TNode> SeparatedList<TNode>(TNode node1, SyntaxToken token, TNode node2) where TNode : XamlSyntaxNode
        {
            return new SeparatedSyntaxList<TNode>(new SyntaxList<XamlSyntaxNode>(SyntaxList.List(node1, token, node2)));
        }

        public static SeparatedSyntaxList<TNode> SeparatedList<TNode>(params XamlSyntaxNode[] nodes) where TNode : XamlSyntaxNode
        {
            if (nodes != null)
            {
