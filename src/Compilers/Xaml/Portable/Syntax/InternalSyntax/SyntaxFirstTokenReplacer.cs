...
{
    internal class SyntaxFirstTokenReplacer : XamlSyntaxRewriter
    {
        ...
        public override XamlSyntaxNode Visit(XamlSyntaxNode node)
        {
            if (node != null)
            {
                if (!_foundOldToken)
        ...
        private static TSyntax UpdateDiagnosticOffset<TSyntax>(TSyntax node, int diagnosticOffsetDelta) where TSyntax : XamlSyntaxNode
        {
