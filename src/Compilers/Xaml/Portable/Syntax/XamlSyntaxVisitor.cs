...
{
    /// <summary>
    /// Represents a <see cref="XamlSyntaxNode"/> visitor that visits only the single XamlSyntaxNode
    ...
    /// </typeparam>
    public abstract partial class XamlSyntaxVisitor<TResult>
    {
        public virtual TResult Visit(SyntaxNode node)
        {
            if (node != null)
            {
                return ((XamlSyntaxNode)node).Accept(this);
            }
    ...
    /// </summary>
    public abstract partial class XamlSyntaxVisitor
    {
        public virtual void Visit(SyntaxNode node)
        {
            if (node != null)
            {
                ((XamlSyntaxNode)node).Accept(this);
            }
        }
