...
{
    /// <summary>
    /// Represents a <see cref="XamlSyntaxVisitor{TResult}"/> which descends an entire <see cref="XamlSyntaxNode"/> graph and
    /// may replace or remove visited SyntaxNodes in depth-first order.
    /// </summary>
    public abstract partial class XamlSyntaxRewriter : XamlSyntaxVisitor<SyntaxNode>
    {
        ...
        public override SyntaxNode Visit(SyntaxNode node)
        {
            if (node != null)
            {
                ...
                var result = ((XamlSyntaxNode)node).Accept(this);
        ...
        public virtual SyntaxTrivia VisitTrivia(SyntaxTrivia trivia)
        {
            ...
            {
                var structure = (XamlSyntaxNode)trivia.GetStructure();
