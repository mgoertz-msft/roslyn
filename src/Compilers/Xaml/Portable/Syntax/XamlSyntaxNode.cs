...
namespace Microsoft.CodeAnalysis.Xaml
{
    ...
    public abstract partial class XamlSyntaxNode : SyntaxNode, IMessageSerializable
    {
        internal XamlSyntaxNode(GreenNode green, SyntaxNode parent, int position)
        ...
        /// </summary>
        internal XamlSyntaxNode(GreenNode green, int position, SyntaxTree syntaxTree)
        ...
        private static SyntaxTree ComputeSyntaxTree(XamlSyntaxNode node)
        {
            ArrayBuilder<XamlSyntaxNode> nodes = null;
            ...
            while (true)
            {
                ...
                if (parent == null)
                {
                    ...
                    Interlocked.CompareExchange(ref node._syntaxTree, XamlSyntaxTree.CreateWithoutClone(node), null);
                    tree = node._syntaxTree;
                    break;
                }
                ...
                (nodes ?? (nodes = ArrayBuilder<XamlSyntaxNode>.GetInstance())).Add(node);
                node = parent;
            }
        ...
        /// </summary>
        internal new XamlSyntaxNode Parent
        {
            get
            {
                return (XamlSyntaxNode)base.Parent;
            }
        }

        internal new XamlSyntaxNode ParentOrStructuredTriviaParent
        {
            get
            {
                return (XamlSyntaxNode)base.ParentOrStructuredTriviaParent;
            }
        }

        // TODO: may be eventually not needed
        internal Syntax.InternalSyntax.XamlSyntaxNode CsGreen
        {
            get { return (Syntax.InternalSyntax.XamlSyntaxNode)this.Green; }
        }
...
#region serialization
        ...
        public static SyntaxNode DeserializeFrom(Stream stream, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            using (var reader = ObjectReader.TryGetReader(stream, cancellationToken: cancellationToken))
            {
                ...
                var root = (Syntax.InternalSyntax.XamlSyntaxNode)reader.ReadValue();
...
#region SyntaxNode members
        ...
        {
            return SyntaxNodeRemover.RemoveNodes(this, nodes.Cast<XamlSyntaxNode>(), options);
        }
        ...
        {
            return SyntaxFactory.AreEquivalent(this, (XamlSyntaxNode)node, topLevel);
        }
