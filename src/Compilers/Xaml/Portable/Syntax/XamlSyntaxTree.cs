...
{
    /// <summary>
    /// The parsed representation of a XAML source document.
    /// </summary>
    public abstract partial class XamlSyntaxTree : SyntaxTree
    {
        ...
        /// </summary>
        public new abstract XamlParseOptions Options { get; }
        ...
        /// <summary>
        /// Produces a clone of a <see cref="XamlSyntaxNode"/> which will have current syntax tree as its parent.
        /// 
        /// Caller must guarantee that if the same instance of <see cref="XamlSyntaxNode"/> makes multiple calls
        ...
        /// <returns>A clone of the original syntax node that has current <see cref="XamlSyntaxTree"/> as its parent.</returns>
        protected T CloneNodeAsRoot<T>(T node) where T : XamlSyntaxNode
        {
            return XamlSyntaxNode.CloneNodeAsRoot(node, this);
        }

        /// <summary>
        /// Gets the root node of the syntax tree.
        /// </summary>
        public new abstract XamlSyntaxNode GetRoot(CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// Gets the root node of the syntax tree if it is already available.
        /// </summary>
        public abstract bool TryGetRoot(out XamlSyntaxNode root);
        ...
        /// </remarks>
        public new virtual Task<XamlSyntaxNode> GetRootAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            XamlSyntaxNode node;
        ...
        /// </summary>
        public static SyntaxTree Create(XamlSyntaxNode root, XamlParseOptions options = null, string path = "", Encoding encoding = null)
        {
            if (root == null)
            {
        ...
        /// <summary>
        /// <para>
        /// Internal helper for <see cref="XamlSyntaxNode"/> class to create a new syntax tree rooted at the given root node.
        /// This method does not create a clone of the given root, but instead preserves it's reference identity.
        /// </para>
        /// <para>NOTE: This method is only intended to be used from <see cref="XamlSyntaxNode.SyntaxTree"/> property.</para>
        /// <para>NOTE: Do not use this method elsewhere, instead use <see cref="Create(XamlSyntaxNode, XamlParseOptions, string, Encoding)"/> method for creating a syntax tree.</para>
        /// </summary>
        internal static SyntaxTree CreateWithoutClone(XamlSyntaxNode root)
        {
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            using (var scanner = new InternalSyntax.Lexer(text, options))
            {
                ...
                {
                    var root = (XamlSyntaxNode)parser.ParseXaml().CreateRed();
