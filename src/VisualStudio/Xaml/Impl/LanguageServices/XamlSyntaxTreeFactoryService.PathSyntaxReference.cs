            ...
            private class PathSyntaxReference : SyntaxReference
            {
                ...
                private ImmutableArray<int> ComputePathFromRoot(SyntaxNode node)
                {
                    ...
                    while (node != root)
                    {
                        ...
                        {
                            throw new InvalidOperationException("XamlWorkspaceResources.Node_does_not_descend_from_root");
                        }
                    }
                ...
                private int GetChildIndex(SyntaxNodeOrToken child)
                {
                    ...
                    throw new InvalidOperationException("XamlWorkspaceResources.Node_not_in_parent_s_child_list");
                }
                ...
                private int GetTriviaIndex(SyntaxTrivia trivia)
                {
                    ...
                    throw new InvalidOperationException("XamlWorkspaceResources.Trivia_is_not_associated_with_token");
                }
