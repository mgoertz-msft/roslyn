...
namespace XmlSyntaxGenerator
{
    internal class TestWriter : AbstractFileWriter
    {
        ...
        private void WriteFile()
        {
            ...
            WriteLine("namespace Microsoft.CodeAnalysis.Xml.UnitTests");
            OpenBlock();
        ...
        private void WriteNodeGenerator(Node node, bool isGreen)
        {
            ...
            var xamlNamespace = isGreen ? "Microsoft.CodeAnalysis.Xml.Syntax.InternalSyntax." : "";
            ...
            //instantiate node
            {
                ...
                foreach (var field in nodeFields)
                {
                    ...
                    else if (field.Type == "XmlSyntaxNode")
                    {
