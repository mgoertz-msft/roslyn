...
namespace Microsoft.CodeAnalysis.Xml.Internal.XmlErrorFactsGenerator
{
    public static class Program
    {
        public static int Main(string[] args)
        {
            ...
            {
                Console.WriteLine(
@"Usage: XmlErrorFactsGenerator.exe input output
  ...
  output    The path to GeneratedErrorFacts.cs");
            ...
            outputText.AppendLine("namespace Microsoft.CodeAnalysis.Xml");
